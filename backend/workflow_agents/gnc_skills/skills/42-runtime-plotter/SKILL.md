...
Read `agent-web/backend/workflow_agents/gnc_skills/skills/42-runtime-plotter/references/repo-sources.md` first.

Use the bundled script:

- `agent-web/backend/workflow_agents/gnc_skills/skills/42-runtime-plotter/scripts/plot_runtime_gnc.py`
...
```bash
python3 agent-web/backend/workflow_agents/gnc_skills/skills/42-runtime-plotter/scripts/plot_runtime_gnc.py --inout <runtime InOut path>
```
