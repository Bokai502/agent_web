...
Read `agent-web/backend/workflow_agents/gnc_skills/skills/aignc-42-orchestrator/references/repo-sources.md` first.
...
- `agent-web/backend/workflow_agents/gnc_skills/knowledge/skills/README.md`
- the leaf skill specs under `agent-web/backend/workflow_agents/gnc_skills/knowledge/skills/`
