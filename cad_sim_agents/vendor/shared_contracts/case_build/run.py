...
def run_stage(
    ...
    try:
        components = read_json(run_root / "00_inputs" / "components.json")
        ...
        native_vtu_src = run_root / "03_simulation" / "native.vtu"
        field_vtu = output_dir / "field.vtu"
        shutil.copy2(native_vtu_src, field_vtu)
        field_samples = read_json(run_root / "03_simulation" / "field_samples.json")
        tensor_summary = read_json(run_root / "03_simulation" / "tensors.json")
        ...
        case_manifest = {
            ...
            "source_artifacts": {
                ...
                "simulation_input": "01_layout/simulation_input.json",
                "field_samples": "03_simulation/field_samples.json",
                "native_vtu": "03_simulation/native.vtu",
                "tensors": "03_simulation/tensors.json",
            },
            "outputs": {
